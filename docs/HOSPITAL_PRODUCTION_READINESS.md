...
- CI runs tests, typecheck, lint, and production build before merge.
...
| Four-portal acceptance | End-to-end tests for all roles and denied cross-role/cross-patient cases | Unassigned | Blocked |
